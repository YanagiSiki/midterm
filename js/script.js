...
//
  ...
  $('.myLink2').click(function(){
	...
	$('.box_images1').hover(function(){
		// Get data attribute values
		var title = $(this).data('title');
		if(!$(this).children("div").length){
			$(this).append('<div class="div_image1"></div>');
		}
		// Get the overlay div
	...
	$('.box_images2').hover(function(){
		...
		var title = $(this).data('title');
		if(!$(this).children("div").length){
			$(this).append('<div class="div_image2"></div>');
		}
		// Get the overlay div
	...
	$('.box_images3').hover(function(){
		// Get data attribute values
		var title = $(this).data('title');
		if(!$(this).children("div").length){
			$(this).append('<div class="div_image3"></div>');
		}
		// Get the overlay div
	...
	$('.box_images4').hover(function(){
		...
		var title = $(this).data('title');
		if(!$(this).children("div").length){
			$(this).append('<div class="div_image4"></div>');
		}
		// Get the overlay div
